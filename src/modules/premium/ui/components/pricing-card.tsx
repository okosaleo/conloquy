...
const pricingCardVariants = cva("rounded-lg p-4 py-6 w-full",{
    variants: {
        variant: {
            ...
            highlighted: "bg-linear-to-br from-primary/80 to-primary  border-primary/20 text-white",
        }
    },
    defaultVariants: {
        variant: "default"
   ...
   <div className={cn(pricingCardVariants({variant}), className, "border")}>
    <div className='flex items-end gap-x-4 justify-between'>
        <div className='flex flex-col gap-y-2'>
            ...
            <p className={cn(pricingCardSecondaryTextVariants({variant}), "text-xs")}>
                {description}
            </p>
        </div>
        <div className='flex items-end gap-x-0.5'>
            ...
            <span className={cn(pricingCardSecondaryTextVariants({variant}), "text-sm")}>
                {priceSuffix}
            </span>
        </div>
      </div>
